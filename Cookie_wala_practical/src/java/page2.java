...
public class page2 extends HttpServlet {
    ...
    out.println("<h1>Visit No : " + count + "</h1>");
                    ...
                    out.println("<h1><a href=page3>Click to visit page no.3</a></h1>");
                    out.println("<h1><a href=page4>Click to visit page no.4</a></h1>");
                    out.println("<h1><a href=page5>Click to visit page no.5</a></h1>");
